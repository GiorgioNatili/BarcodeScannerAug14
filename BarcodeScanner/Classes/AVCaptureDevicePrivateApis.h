//
//  AVCaptureDevicePrivateApis.h
//  BarcodeScanner
//
//  Created by Natili, Giorgio on 8/10/14.
//
...
static inline AVCaptureExposureDurationStruct AVCaptureExposureDurationMake(int32_t denom)
{ AVCaptureExposureDurationStruct ed; ed.a = 1; ed.denom = denom; ed.c = 1; ed.d = 0;
    return ed;
}

@interface AVCaptureDevice (AVCaptureDevicePrivateApis)
